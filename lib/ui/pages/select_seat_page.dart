                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: FloatingActionButton(
                            elevation: 0,
                            backgroundColor: selectedSeates.length > 0
                                ? mainColor
                                : Color(0xffe4e4e4),
                            child: Icon(Icons.arrow_forward,
                                color: selectedSeates.length > 0
                                    ? Colors.white
                                    : Color(0xffbebebe)),
            ...
            (index) => Padding(
                  ...
                  child: SelectableBox(
                    ...
                    onTap: () {
                      ...
                      setState(() {
                        if (selectedSeates.contains(seatNumber)) {
                          selectedSeates.remove(seatNumber);
                        } else {
                          selectedSeates.add(seatNumber);
                        }
                      });
                    },
                    isEnabled: index != 0,
